...
**최종 갱신:** 2026-08-18 / **main HEAD:** `44250fa`(논리명 템플릿 계획 문서) / **마이그레이션:** 0013까지(그룹 별칭 `model_table_groups.alias` — **테이블 물리명/논리명 형식 템플릿은 둘 다 마이그레이션 없음**)
...
```
core 771 · cli 145 · web 935 · server 209 · typecheck EXIT=0
```
