...
**최종 갱신:** 2026-08-12 / **main HEAD:** `ba623a8`(선택 테이블로 새 그룹 만들기 병합 + 인계 갱신) / **마이그레이션:** 0012까지(초대·재설정 링크에서 `invitations`·`password_reset_tokens` 추가)
...
```
core 630 · cli 138 · web 757 · server 196 (erdd_test) · typecheck EXIT=0
```
