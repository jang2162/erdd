...
```
core 737 · cli 143 · web 926 · server 206 · typecheck EXIT=0
```

테이블 물리명 형식 템플릿 사이클에서 **core +37 · cli +2 · web +9 · server +4** 가 붙었다(직전 기준선은
`core 700 · cli 141 · web 917 · server 202`). ⚠️ **server 수치는 워크트리 격리 DB(`erdd_test_c`)로
