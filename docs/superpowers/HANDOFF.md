...
**최종 갱신:** 2026-09-03 / **main HEAD:** `89a3b61`(`docs: 현재 구현과 어긋난 서술 5건을 바로잡는다` — 문서 정리 사이클) / **마이그레이션:** 0013까지(그룹 별칭 `model_table_groups.alias` — **테이블 물리명/논리명 형식 템플릿은 둘 다 마이그레이션 없음**)
