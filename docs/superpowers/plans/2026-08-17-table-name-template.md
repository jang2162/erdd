...
- [x] **Step 1: 세 테스트 파일에 심을 넣는다 (호출부는 안 건드린다)**
...
- [x] **Step 5: 용어 검사 분리가 진짜 잠기는지 실증한다**
...
- [x] **Step 5: 통과를 확인하고 서버 스키마를 실증한다**
